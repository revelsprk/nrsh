...
export default function WatchPage() {
        ...
        try {
            ...
            `https://www.googleapis.com/youtube/v3/videos`,
            {
                params: {
                    part: "snippet",
                    id: videoId,
                    key: process.env.NEXT_PUBLIC_YOUTUBE_API_KEY, // 環境変数から取得
                },
            }
            );
    ...
    const linkify = (text: string) =>
        text.replace(/(https?:\/\/[^\s]+)/g, '<a href="$1" target="_blank" rel="noopener noreferrer" class="text-blue-600 underline">$1</a>');
    ...
    <div>
        ...
        <div className="md:w-3/4 mx-auto mt-10">
            ...
            <p className="text-gray-600 whitespace-pre-line" dangerouslySetInnerHTML={{ __html: linkify(decode(video.snippet.description)) }}/>
        </div>
